...
module.exports = function ({plugins} = {}) {
  ...
  if (plugins && plugins.adminExtensions && plugins.adminExtensions.length) {
    plugins.adminExtensions.forEach(ext => ext(app));
  }
  app.all('/users', require('./routes/users')());
  app.all('/apps', require('./routes/apps')());
  app.all('/scopes', require('./routes/scopes')());
  app.all('/credentials', require('./routes/credentials')());
  app.all('/tokens', require('./routes/tokens')());
  ...
  app.all('/api-docs', swaggerUi.serve, swaggerUi.setup(swaggerDocument));
